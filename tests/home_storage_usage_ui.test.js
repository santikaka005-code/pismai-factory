...
assert.match(app, /HOME_STORAGE_REFRESH_INTERVAL_MS = 30000/);
assert.match(app, /startHomeStorageUsageRefresh/);
assert.match(app, /stopHomeStorageUsageRefresh/);
assert.match(server, /STORAGE_USAGE_CACHE_SECONDS = 15/);
