...
assert.match(controller, /data-percent-start-date/);
assert.match(controller, /data-percent-end-date/);
assert.match(controller, /state\.endDate = addDays\(state\.startDate, 6\)/);
